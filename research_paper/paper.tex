...
\begin{enumerate}
    ...
    \item \textbf{Empirical Validation \& Reproducibility}: We evaluate PRIVATRIS on the open \textit{BeaverTails} safety benchmark, showing it outperforms state-of-the-art baselines (including \textit{Safe-RLHF} and \textit{Constitutional AI}) in maintaining safety over long interaction horizons. All training configurations and code are publicly available to facilitate reproducibility.
\end{enumerate}
