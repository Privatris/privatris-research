...
\begin{enumerate}
    ...
    \item \textbf{Multi-Dataset Empirical Validation}: We evaluate PRIVATRIS on two complementary safety benchmarks---\textit{BeaverTails} (330k safety-annotated QA pairs) and \textit{Anthropic HH-RLHF} (161k helpful/harmless dialogues)---demonstrating consistent safety maintenance across diverse adversarial scenarios while preserving task utility. All code and configurations are publicly available.
\end{enumerate}
